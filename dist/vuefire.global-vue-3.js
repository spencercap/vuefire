/*!
 * vuefire v3.0.0-alpha.13
 * (c) 2021 Eduardo San Martin Morote
 * @license MIT
 */
var Vuefire = (function (exports, vueDemi) {
  'use strict'
    ...
    function recursiveExtract(doc, oldDoc, path, result) {
      ...
      for (const key in doc) {
        ...
        if (
          ...
          data[key] = {}
          recursiveExtract(ref, oldDoc[key], path + key + '.', [
            data[key],
            refs,
          ])
        } else {
   ...
   * @param pluginOptions
   */
  const rtdbPlugin = function rtdbPlugin(
    app,
   ...
   * @param pluginOptions
   */
  const firestorePlugin = function firestorePlugin(
    app,
